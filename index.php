			...
			<div class="header-bar-warp d-flex">
				...
				<nav class="top-nav-area w-100">
					<div class="user-panel">
						<a href="signin.html">Sign In/Log In</a>
					</div>
					<!-- Menu -->
					<ul class="main-menu primary-menu">
						<li><a href="games.php">Games</a></li>
						<li><a href="pointstore.html">Points Store</a></li>
	...
	<footer class="footer-section">
		<div class="container">
			...
			<div class="footer-right-pic">
				<img src="img/footer-right-pic.png" alt="man">
			</div>
			...
			<ul class="main-menu footer-menu">
				<li><a href="games.php">Games</a></li>
				<li><a href="pointstore.html">Point Store</a></li>
				<li><a href="signin.html">Sign In/Log In</a></li>
			...
			<div class="copyright"><a href="">Colorlib</a> 2025 @ All rights reserved</div>
		</div>
	</footer>
	<!-- Footer section end -->
